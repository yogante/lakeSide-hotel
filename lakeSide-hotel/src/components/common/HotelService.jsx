          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Stay connected with hight-spped internet access.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Start your day with a delcious breakfast buffet.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Park your car conveniently in our on-site.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>Stay cool and conformtable with our air conditioning system.</Card.Text>
              </Card.Body>
            </Card>
          </Col>
        </Row>
