  ...
  return (
    <>
      <div className='container mt-5 d-flex flex-column justify-content-center align-items-center'>
        ...
        <form onSubmit={handleFormSubmit} className='col-md-6' action="">
        ...
        {isLoading ? (
          ...
          : error ? (
            <div className='tex-danger'>{error}</div>
        ...
        {isDeleted && (
          <div className='alert alert-success mt-3 mb'
            onClick={() => handleBookingCancellation(bookingInfo.bookingId)}>{successMessage}Booking has been cancelled successfully!</div>
        )}
      </div>
    </>
  )
