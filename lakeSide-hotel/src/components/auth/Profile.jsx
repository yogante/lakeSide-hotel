...
const Profile = () => {
  ...
  const handleDeleteAccount = async () => {
    const confirmed = window.confirm(
      "Are you shure you want to delete your account? This action cannot be undone."
    )
    if (confirmed) {
    ...
    <div>
      ...
      {user ? (
        <div className='card p-5 mt-5' style={{ backgroundColor: "whitesmoke" }}>
          <h4 className='card-body'>User Information</h4>
                ...
                <div className='row g-0'>
                  <div className='col-md-2'>
                    <div className='d-flex justify-content-center align-items-center mb-4'>
                      <img
                        src="https://themindfulaimanifesto.org/wp-content/uploads/2020/09/male-placeholder-image.jpeg" alt="Profile"
